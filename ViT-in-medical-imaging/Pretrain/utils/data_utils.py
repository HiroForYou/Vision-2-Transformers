...
def get_loader(args):
    ...
    vallist4 = load_decathlon_datalist(
        jsonlist4, False, "validation", base_dir=datadir4
    )
    vallist5 = load_decathlon_datalist(
        jsonlist5, False, "validation", base_dir=datadir5
    )
